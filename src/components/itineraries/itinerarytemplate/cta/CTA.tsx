// src/components/itineraries/itinerarytemplate/cta/CTA.tsx
...
export function CTA({ tripData }: CTAProps) {
  ...
  const handleBookNow = () => {
    const bookingPath = `/trips/${tripData.id}/book` as Route;
            ...
            {tripData.destinations?.length > 0 && (
              <div className={styles.summaryBlock}>
                ...
                <div className={styles.destinationList}>
                  {tripData.destinations.map((destination: string, index: number) => (
